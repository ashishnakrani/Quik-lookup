...
import downarrowlatest from "../../assets/images/down-arrow-new.svg";
import denmarklogo from "../../assets/images/denmark-lg-logo.svg";
import localization from "../../assets/images/localization.png";
import isoIcon from "../../assets/images/isoIcon.svg";
import dataFormat from "../../assets/images/date-format.svg";
import decimalSeperator from "../../assets/images/decimal-seperator.svg";
import workDays from "../../assets/images/work-days.svg";
import postalCodes from "../../assets/images/postal-codes.svg";
import ai from "../../assets/images/ai.svg";
import GraphQLIcon from "../../assets/images/GraphQL-icon.svg";
import PythonIcon from "../../assets/images/Python-icon.svg";
import phpicon from "../../assets/images/R_logo-color.svg";
import cicon from "../../assets/images/cicon.svg";
import phpIcon from "../../assets/images/phpicon.svg";
import InstantLight from "../../assets/images/Instant-light.svg";
import avoidStale from "../../assets/images/avoid-stale.svg";
import Frictionless from "../../assets/images/Frictionless.svg";
import stopwatchRegular from "../../assets/images/stopwatch-regular.svg";
import excelSpreadsheets from "../../assets/images/excel-spreadsheets.svg";
import googleSheets from "../../assets/images/google-sheets.svg";
import spreadsheetOne from "../../assets/images/spreadsheet_one.svg";
import spreadsheetTwo from "../../assets/images/spreadsheet_two.svg";
import nextWhite from "../../assets/images/next-white.svg";
import previousWhite from "../../assets/images/previous-white.svg";
...
const list_data = [
  ...
  },
  {
    ...
    description: "If it is reasonable to resolve it as a Country, we will!",
  },
  {
    image: ai,
    title: "AI based reference resolver",
    description: "Drastically speeds up data cleaning as well.",
  },
  {
    image: s_logo,
    title: "Try it now",
    description: "Using a name, Geo Location, Currency, IP address or ...",
  },
];
const fingertips_list_data = [
  {
    icon: InstantLight,
    title: "Instant use with plugins",
    description: "No data infrastructure required.",
  },
  {
    icon: avoidStale,
    title: "Avoid stale or outdated data",
    description: "Direct use eliminates the need for local downloads",
  },
  {
    icon: stopwatchRegular,
    title: "Super Fast",
    description: "With local caching and regional data centers",
  },
  {
    icon: Frictionless,
    title: "Frictionless Use",
    description: "With automatic data formatting and unit conversion.",
  },
];
const localization_list_data = [
  {
    img: dataFormat,
    title: "Date Format",
    description: "Lorem ipsiu dolor sit amte, liberate me ex inferis pater noster.The readable version will always results in the same (Named) UUID and the same UUID will always point to Denmark, regardless of IT system.",
  },
  {
    img: decimalSeperator,
    title: "Decimal Seperator",
    description: "Lorem ipsiu dolor sit amte, liberate me ex inferis pater noster ",
  },
  {
    img: workDays,
    title: "Work  Days & Weeks",
    description: "Lorem ipsiu dolor sit amte, liberate me ex inferis pater noster ",
  },
  {
    img: postalCodes,
...
const Supported_spreadsheets = [
  {
    logo: excelSpreadsheets,
  },
  {
    logo: googleSheets,
  },
...
const source_resource_data = [
  {
    logo: dbpedia,
    title: "Db Pedia",
    description: "Pellentesque rhoncus congue semper. Pellentesque rhoncus congue semper. Pellentesque rhoncus congue semper. Pellentesque rhoncus congue semper. Pellentesque rhoncus congue semper. ",
  },
  {
    logo: dbpedia,
    title: "Db Pedia",
...
export default class Home extends Component {
  ...
  render() {
    ...
    return (
      <>
        <section className="location-navbar-top">
          <div className="location-navbar">
            <Row justify="end" gutter={16}>
              ...
              <Col className="breadcrump-right-menu">
        ...
        <section className="banner-section">
          <div className="container-fluid carousel-with-ribbon">
            <Carousel
              dots={false}
              infinite
              slidesToShow={1}
            ...
            >
              <div className="item">
                <div className="carousel-banner ribbons-wrapper">
                  <Button>
                    <Link to="#">
                      Always <b> Free</b>
                    </Link>
                  ...
                  <div className="banner-content">
                    <Title level={2}>
                      Likely <strong>The Best API For Countries</strong> You'll Ever Find
                    </Title>
                  </div>
                </div>
              </div>
              <div className="item">  
                <div className="carousel-banner carousel-banner-primary ribbons-wrapper">
                  <Button>
                    <Link to="#">
                      Always <b> Free</b>
                    </Link>
              ...
              <div className="item">
                <div className="carousel-banner carousel-banner-secondary ribbons-wrapper">
                  <Button>
                    <Link to="#">
                    ...
                    <Col xl={15} xs={24}>
                      <Row gutter={{ xl: 16, lg: 8, md: 8 }}>
                        ...
                        <Col xl={8} lg={8} md={8} sm={0} xs={0}>
                          ...
                          >
                            <Title level={4}>Simple <br/> Use</Title>
                            <Title level={5}>Our Manifesto</Title>
                          </Card>
                        </Col>
                      </Row>
            ...
            <Row>
              <Col md={24} xs={24}>
                <div className="primary-vertical-list">
                  ...
                  />
                  <Link to="/"><b>See all<Image src={downarrowlatest} alt="" className="see-all-down-btn"/></b></Link>
                </div>
        ...
        <section className="currency-section">
          <div className="container inner-container">
            <Row className="box">
              <Col md={24} xs={24} className="country-title country-title--lg">
                <Title level={4} className="country-name"><img src={denmarklogo} className="country-image" alt="" />Denmark</Title>
              </Col>
               {/* map section */}
        <section className="map-section">
          <div className="">
            <Row className="box">
              <Col md={{ span: 15, order: 1 }} xs={{ span: 24, order: 2 }}>
              ...
              <Col className="maps-all-right" md={{ span: 8, offset: 1, order: 2 }} xs={{ span: 24, order: 1 } }
              >
                <Title level={1}>Maps in all flavors</Title>
                <Paragraph className="country-details-para">
                  ...
                  can even fetch a simplified version using <b>1:1</b> 1:5 
                  or 1:300 scale
                </Paragraph>
              ...
              <Col xl={10} lg={10} md={10}>
                ...
                <Row className="danish-krone-text">
                  <Col md={12} xs={14}>
                    <Title level={2}>Danish Krone</Title>
                  </Col>
                  <Col md={12} xs={10}>
                    <Title level={3} type="secondary">
                      <span>Kr.</span> / <span>øre</span>
                    </Title>
                  </Col>
                </Row>
                ...
                <div className="local-name">
                  <Title level={5}>Local Name</Title><p>Krøne / øre</p>
                </div>
                <div className="local-name">
                  <Title level={5}>Units :</Title><p>Krone  / Ore (0.00)</p>
                </div>
                <div>
                </div>
                ...
                <Title level={5} className="currency-history">Currency History</Title>
                ...
                <div className="primary-sources-paragraph hidden-sm hidden-xs">
                  <Paragraph>Primary Sources:</Paragraph>
                  <Divider />
                  <List
                    itemLayout="vertical"
          ...
          <div className="container inner-container">
            <div className="box">
              ...
              <Row>
                ...
                <Col xl={{ span: 10, offset: 1}} lg={{ span: 10,offset: 1}} md={{ span: 10, offset: 1}}>
        ...
        <section className="uid-section">
          <div className="container inner-container">
            <Row className="list-box">
              <Col md={24} xs={24} className="country-title country-title--sm">
                <Title level={4} className="country-name"><img src={denmarklogo} className="country-image" alt="" />Denmark</Title>
              </Col>
              ...
              <Col offset={1} xl={11} lg={11} md={11} className="uuid-content">
                <div className="hidden-sm hidden-xs">
                  <Title level={1} className="uuid-content__heading">All the IDs</Title>
                  <Title level={2} className="uuid-content__subheading">... plus one</Title>
                </div>
                <Paragraph>
          ...
          <div className="container inner-container">
            <Row className="content-box">
              <Col xl={12} lg={12} md={16} sm={24} xs={24}>
                ...
                <List
                  itemLayout="horizontal"
                  dataSource={localization_list_data}
                  renderItem={(item) => (
                    <List.Item>
                      <List.Item.Meta/>
                      <div className="localization-list">
                        <div className="localization-list__icon">
                          <img src={item.img} alt="" />
                        </div>
                        <div className="localization-list__details">
            ...
            <div className="resources-bg">
              ...
              <Row>
                <Col xl={20}>
                  <div className="services-subtitle">
                    <Title level={5}>
                      Today in
                      <div className="ant-select-single-line ant-select-single-line1">
                ...
                <Col xl={8} lg={8} md={8} xs={24}>
                  <div className="resource-inner-box">
                    ...
                    <div className="calender-desc-box">
                      <Row>
                        <Col xl={12} lg={12} md={12} xs={12} className="calender-desc-box__active">
                          <div className="calender-desc workday">
                            <Text>Workdays</Text>
                          </div>
                          <div className="calender-desc-box__Observances">
                            <Text>Observances</Text>
                          </div>
                        </Col>
              ...
              <Row>
                <Col xl={8} lg={8} md={9} xs={24}>
                    <div className="slider-wrapper slider-wrapper-2">
                        <span className="year-text">1950</span>
                        <Slider marks={marks} min={1894} max={2022} />
                    </div>
                </Col>
              </Row>
            </div>
          ...
          <div className="container inner-container">
            <Row align="middle">
              <Col md={16} xs={16}>
                ...
                <Title level={2}>
                  Resources you need to build your own  dataset
                </Title>
              </Col>
              <Col md={8} xs={8}>
                <Select defaultValue="land" size="large" className="denmark-dropdown">
                  <Option value="land">All (34)</Option>
                  <Option>Websites (2),</Option>
                  <Option>Sources (12)</Option>
                  <Option>Authorities (12)</Option>
                  <Option>Standards (16)</Option>
                  <Option>Social (6)</Option>
                </Select>
              </Col>
            </Row>
            <Carousel
        ...
        <section className="free-access-section">
          <div className="container access-inner-box inner-container">
            <Row justify="center">
              <Col xl={12} lg={12} md={12} sm={20} xs={24}>
                <div className="box">
                  <Row>
                    <Col xl={14} lg={15} md={16} xs={15}>
          ...
          <div className="container inner-container">
            <Row className="box" justify="center" align="middle">
              ...
              <Col md={{ span: 13, order: 2 }} xs={{ span: 24, order: 1 }}>
                <Title level={1}>
                  Fully linked data<br /> <span>for fast, effortless, access</span> 
                </Title>
                <Paragraph>
                  <p>
         ...
         */}
        <section className="data-fingertips-section">
          <div className="container inner-container">
            <div className="box">
              <div className="fingertips-title-line">
                <img src={timer} className="timer-clock-icon" alt="" />
                <div className="fingertips-title-line-text">
                  <Title level={1} className="fingertips-main-title"> Data At Your Fingertips</Title>
                  <Title level={2} className="fingertips-main-pera"> Plugins available for the tools you use and love </Title>
                </div>
              </div>
              <Tabs defaultActiveKey="1" onChange={() => {}}>
                <TabPane tab={
                    <>
                      <img src={Spreadsheets} /> 
                      Spreadsheets
                    </>
                  } key="1">
                 <div className="plugin-video-player"> 
                    <img src={videoImg} alt="" />
                  </div>
                  <div className="spreadsheets-list data-fingertips">
                    <List
                      itemLayout="horizontal"
                      dataSource={fingertips_list_data}
                      renderItem={(item) => (
                        <List.Item>
                          <List.Item.Meta
                  ...
                  <div className="supported-main-spreadsheets">
                    <Title level={4} className="supported-title"> Supported Spreadsheets </Title>
                    <Menu
                        onClick={this.handleClick}
                        selectedKeys={[current]}
                        mode="horizontal"
                      >
                        {Supported_spreadsheets &&
                          Supported_spreadsheets.map((item) => (
                            <Menu.Item
                              key="item"
                              style={{ width: "16%" }}
                ...
                <TabPane tab={
                  ...
                  <div className="for-sheets">
                    <Title level={2} className="for-sheets-title"> For</Title>
                  </div>
        ...
        <section className="try-our-api-section">
          <div className="container inner-container">
            <div className="box">
              <Title level={1} className="box__title"> Try Our API Now. </Title>
              <Title level={2} className="box__pera"> Using Our Live Code Examples</Title>

              <Row className="box__code-examples">
                <Col md={12} xs={12}>
                  <Select defaultValue="land" size="large" className="box__code-examples__select">
                ...
                <Col md={12} xs={12}>
                  <div className="box__code-examples__icon">
                    <Menu
                        onClick={this.handleClick}
                        selectedKeys={[current]}
                        mode="horizontal"
                      >
                      {apiNow_data.map((item) => (
                          <Menu.Item
                            key="item"
                            style={{ width: "15%" }}
                            icon={<img src={item.logo} alt="" />}
                  ...
                  <div className="left-part">
                        ...
                        <div className="code">
                          <pre>
                              ...
                              <p>obj.employees[1].firstName+""+obj.employees[1].lastName;</p>
                              <p>document.getElementById("demo").innerHTML =</p>
                              <p>obj.employees[1].firstName+""+</p>
                              <p>document.getElementById("demo").innerHTML =</p>
                              <p>obj.employees[1].firstName+""+obj.employees[1].lastName;</p>
                              <p>obj.employees[1].lastName;</p>
                              &lt;/script&gt;
                          </pre>
                        </div>
                  </div>
            ...
            <Row justify="center">
              <Col md={18} xs={24}>
                <Carousel
                  ...
                  autoplay
                  arrows
                  nextArrow={<img src={nextWhite} alt="" />}
                  prevArrow={<img src={previousWhite} alt="" />}
                  responsive={[
                    {
                      breakpoint: 1200, // tablet breakpoint
                      settings: {
            ...
            <Row>
              <Col xl={24} xs={24}>
                ...
                <Title level={2}>
                  ...
                  contribute back to source projects as much as possible. <br /> Here
                  you find all the information you need to build your own list
                  of countries as well as information that helps you along the
                  way.
                </Title>
                <div className="source-main-box">
                  <Row className="source-main-row">
                        ...
                        <List itemLayout="horizontal">
                          {source_resource_data &&
                            source_resource_data.map((item) => (
                              <List.Item>
                                <div className="source-main-content">
                                  <div className="source-main-content__title">
                                    <img src={item.logo} alt="" />
                                    <h5>{item.title}</h5>
                                  </div>
                                  <p className="source-main-content__para">{item.description}</p>
                                </div>
                              </List.Item>
                            ))}
                        </List>
          ...
          <div className="container inner-container">
            <Row justify="center" align="middle">
              <Col xs={24} sm={24} md={16}>
                ...
                <Title level={2}>
                  API access to the Best list of Countries will always be free <br />
