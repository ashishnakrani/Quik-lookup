...
import customizemenu from '../../assets/images/customize-menu.svg';
        ...
        return (
            <>
                <div className="data-table">
                    ...
                    <Row>
                        <Col md={24} xs={24} className="countries-datatable-wrapper">
                    ...
                    <Row gutter={8}>
                        ...
                        <Col xxl={{span:6,offset:7}} xl={{span:6, offset:7}} lg={{span:8, offset:4}} md={{span:10, offset:0}} xs={24}>
                            <Button  onClick={() => this.setModal1Visible(true)}  className="fetch-btn">Customize which Country properties you fetch <Image src={customizemenu} alt=""/></Button>
                        ...
                        <Col xl={3} lg={{span:4}} md={{span:5}} xs={24}>
                            <Button onClick={() => this.setModal2Visible(true)} className="csv-btn"> Download  Table<DownloadOutlined /></Button>   
                            <Modal 
                                title="How Would You Like Your Dataset?"
                                centered
                                className="dataset-popu"
